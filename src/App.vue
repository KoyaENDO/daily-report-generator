      ...
      dailyReportResult: function () {
        ...
        Object.keys(resultBreakDownArray).forEach(function(key) {
          ...
          if (key in planBreakDownArray) {
            ...
            let differenceString = difference > 0 ? ("+" + difference.toFixed(2)) : difference.toFixed(2)
            breakDownContent = "【" + key + "】" + hour.toFixed(2) + "H (" + differenceString + "H)" + "\n"
          } else {
            breakDownContent = "【" + key + "】" + hour.toFixed(2) + "H (+" + hour.toFixed(2) + "H)" + "\n"
          }
        ...
        Object.keys(planBreakDownArray).forEach(function(key) {
          if (!(key in resultBreakDownArray)) {
            ...
            let breakDownContent = "【" + key + "】0.0H (-" + hour.toFixed(2) + "H)" + "\n"
            dailyReportContents += breakDownContent
          }
        }, planBreakDownArray)
